...
#   kernelspec:
#     display_name: 01-odes-and-sdes
#     language: python
#     name: 01-odes-and-sdes
# ---
...
#
# $$dX_t = u_t(X_t)\,dt  \quad \rightarrow \quad X_{t + h} = X_t + h\,u_t(X_t),$$
#
# where $h = \Delta t$ is the *step size*. Similarly, the Euler-Maruyama scheme corresponds to the discretization
#
# $$dX_t = u(X_t,t)\,dt + \sigma_t\,dW_t  \quad \rightarrow \quad X_{t + h} = X_t + h\,u_t(X_t) + \sqrt{h}\,\sigma_t\,z_t, \quad z_t \sim \mathcal{N}(0,I_d).$$
#
...
# %% [markdown]
# # ✍ IMPLEMENT #2 of 5 — Problem 1.1b
# **`EulerMaruyamaSimulator.step`**
#
# ---
...
# %% [markdown]
# # ✍ IMPLEMENT #3 of 5 — Problem 2.1
# **`BrownianMotion` — drift & diffusion coefficients**
#
# ---
...
# %% [markdown]
# # ✍ IMPLEMENT #4 of 5 — Problem 2.2
# **`OUProcess` — drift & diffusion coefficients**
#
# ---
...
# %% [markdown]
# # ✍ IMPLEMENT #5 of 5 — Problem 3.1
# **`LangevinSDE` — drift & diffusion coefficients**
#
# ---
